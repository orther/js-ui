var animator = (function () {
    ...
    var animationInt         = null;
    var tasks                = [];
    var animatorIntervalTime = 13; // In milliseconds
    ...
    var animationTask = function (params) {
        ...
        this.totalSteps = (this.duration / animatorIntervalTime) + 1;
        logToScreen(this.totalSteps);
    }

    // -----------------------------------------------------------------------------------------------------------------

    var easing = {
    	easeInQuad: function (elapsedTime, startingValue, endingValue, duration) {
	    	return ((endingValue * (elapsedTime /= durationa)) * elapsedTime) + startingValue;
    	},
    	easeOutQuad: function (elapsedTime, startingValue, endingValue, duration) {
	    	return ((-endingValue * (elapsedTime /= duration)) * (elapsedTime - 2)) + startingValue;
    	}
    }
